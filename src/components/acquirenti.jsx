        ...
        <Container>
            ...
            <Form>
                <Form.Group controlId="formDenominazione">
                    ...
                    <Form.Control type="text" placeholder="Inserisci Ragione Sociale/Cognome Nome" onChange={(e) => setFormData({ ...formData, denominazione: e.target.value })} />
                </Form.Group>
                <Form.Group controlId="formPartitaIva">
                    <Form.Label>Partita Iva</Form.Label>
                    <Form.Control type="text" placeholder="Inserisci Partita Iva" onChange={(e) => setFormData({ ...formData, partitaIva: e.target.value })} />
                </Form.Group>
                <Form.Group controlId="formCodiceFiscale">
                    <Form.Label>Codice Fiscale</Form.Label>
                    <Form.Control type="text" placeholder="Inserisci Codice Fiscale" onChange={(e) => setFormData({ ...formData, codiceFiscale: e.target.value })} />
                </Form.Group>
                ...
                <Form.Group controlId="formCitta">
                    ...
                    <Form.Control type="text" placeholder="Inserisci Città" onChange={(e) => setFormData({ ...formData, citta: e.target.value })} />
                </Form.Group>
